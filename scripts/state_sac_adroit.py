...
def parse_args():
    ...
    parser.add_argument("--utd", type=float, default=0.25, # use 0.0625 for door
    ...
    parser.add_argument("--reward-scale", type=float, default=0.1) # use 1 for relocate
...
if __name__ == "__main__":
    ...
    if args.capture_video:
        ...
        if args.num_eval_envs == 1:
            VecEnv = gym.vector.SyncVectorEnv
        else:
